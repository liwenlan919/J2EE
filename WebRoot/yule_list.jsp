...
<c:forEach items="${pi.list}" var="obj" varStatus="con">
  <tr class="tdbg">
    ...
    <td bgcolor="#FFFFFF"><div align="center"><a href="<%=request.getContextPath() %>/yuledelete_admin?par.id=${obj.id }" onClick="return confirm('确定删除吗？')">删除</a>
    &nbsp;&nbsp;<a href="yule_detail?mvo.id=${obj.id }">浏览</a>
