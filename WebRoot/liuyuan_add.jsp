...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="748">
      <s:form action="/liuyuanadd_admin" method="post"  onsubmit="return add();">
      <s:token></s:token>
    <table width="600" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF"><textarea name="mvo.content" id="content" cols="60" rows="20"></textarea>
        <input type="hidden" name="mvo.rid" value="123"  /> 
        </td>
      </tr>
      <tr>
