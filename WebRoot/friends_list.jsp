      ...
      <table width="735" border="0">
        ...
        <tr>
		  ...
		  <table width="150" border="0" style="float:left;">
            <tr>
              <td height="96" align="center"><a href="members_show?mvo.id=${obj.members.id}"><img  src="${obj.members.picurl}"  width="129" height="96" border="0" /></a></td>
            </tr>
            <tr>
              <td align="center">${obj.members.username}&nbsp;<a href="Friendsdelete_admin?par.id=${obj.id}">解除</a>&nbsp;<a href="members_show?mvo.id=${obj.members.id}">查看</a></td>
            </tr>
          </table>
		  </c:forEach>
