...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	&nbsp;&nbsp;<a href="photostoadd_admin">我要上传照片
    </a><br />
  ...
  <tr class="title_top">
    <td width="26%" align="center" bgcolor="#FFFFFF"><strong>题目</strong></td>
      <td width="26%" align="center" bgcolor="#FFFFFF"><strong>图片</strong></td>
...
<c:forEach items="${pi.list}" var="obj" varStatus="con">
  <tr class="tdbg">
    ...
    <td bgcolor="#FFFFFF"><div align="center">${obj.subject}</div></td>
      <td bgcolor="#FFFFFF"><div align="center"><img src="${obj.url}" with="100" height="100"/></div></td>
    <td bgcolor="#FFFFFF"><div align="center"><a href="<%=request.getContextPath() %>/photosdelete_admin?par.id=${obj.id }" onClick="return confirm('确定删除吗？')">删除</a>&nbsp;&nbsp;<a href="photos_play?mvo.id=${obj.id }">浏览</a></div></td>
	</tr>
		</c:forEach>
</table>
...
<div align="center">
	<jsp:include page="/pageinfo.jsp">
									<jsp:param value="photoslist_admin" name="path"/>
  </jsp:include>
</div>
    </td>
  </tr>
