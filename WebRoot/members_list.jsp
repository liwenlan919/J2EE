      ...
      <table width="735" border="0">
        ...
        <tr>
		  ...
		  <table width="150" border="0" style="float:left;">
            <tr>
              <td height="96" align="center"><img  src="${obj.picurl}"  width="129" height="96" border="0" /></td>
            </tr>
            <tr>
              <td align="center">${obj.username}&nbsp;浏览数：${obj.hits}次 &nbsp;<a href="Friendsadd_admin?mvo.members.id=${obj.id}">加为好友</a></td>
            </tr>
          </table>
		  </c:forEach>
