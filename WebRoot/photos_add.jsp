...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="748">
      <s:form action="/photosadd_admin" method="post"  onsubmit="return add();" enctype="multipart/form-data">
      <s:token></s:token>
    <table width="600" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
      ...
      <tr>
        <td height="30" align="right" bgcolor="#FFFFFF">相册：</td>
        <td bgcolor="#FFFFFF">
        <s:file name="fvo.myFile" id="file" theme="simple"></s:file>
        </td>
      </tr>
      <tr>
