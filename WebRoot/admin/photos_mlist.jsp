...
<c:forEach items="${pi.list}" var="obj" varStatus="con">
  <tr class="tdbg">
    ...
    <td><div align="center"><a href="<%=request.getContextPath() %>/photosmdelete_admin?par.id=${obj.id }" onClick="return confirm('确定删除吗？')">删除</a></div></td>
	</tr>
			</c:forEach>
</table>
...
<div align="center">
	<jsp:include page="/pageinfo.jsp">
									<jsp:param value="photosmlist_admin" name="path"/>
  </jsp:include>
</div>
