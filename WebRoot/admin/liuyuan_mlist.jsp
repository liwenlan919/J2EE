...
<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" class="border">
  <tr class="title_top">
    ...
    <td width="11%" align="center"><strong>内容</strong></td>
       <td width="11%" align="center"><strong>时间</strong></td>
...
<c:forEach items="${pi.list}" var="obj" varStatus="con">
  <tr class="tdbg">
    ...
    <td>&nbsp;	${obj.uid}</td>
    <td><div align="center">${obj.content}</div></td>
      <td><div align="center">${obj.addtime}</div></td>
    <td><div align="center"><a href="<%=request.getContextPath() %>/liuyuanmdelete_admin?par.id=${obj.id }" onClick="return confirm('确定删除吗？')">删除</a></div></td>
	</tr>
			</c:forEach>
</table>
...
<div align="center">
	<jsp:include page="/pageinfo.jsp">
									<jsp:param value="liuyuanmlist_admin" name="path"/>
  </jsp:include>
</div>
